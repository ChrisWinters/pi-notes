# Pi Extensions Docs (Local Snapshot)

- Source: https://raw.githubusercontent.com/badlogic/pi-mono/refs/heads/main/packages/coding-agent/docs/extensions.md
- Upstream project: `badlogic/pi-mono` (`packages/coding-agent/docs/extensions.md`)
- Snapshot added to this repo: **2026-04-05**
- Purpose: Keep a local copy of Pi extension guidance so `pi-notes` implementation stays aligned with official docs.
- Note: This is a point-in-time snapshot and may drift from upstream.
